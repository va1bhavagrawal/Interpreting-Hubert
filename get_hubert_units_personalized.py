...
if __name__ == "__main__":
    ...
    for speaker in SPEAKERS:
        ...
        for recording_data in speaker_data:
            ...
            cluster_units = kmeans_model.predict(features.squeeze(0).cpu().numpy()) 
            ...
            all_clusters.extend(cluster_units[non_empty_ids]) 

    # Ensure the lengths match
    assert len(all_phonemes_unstressed) == len(all_features) == len(all_clusters), "Mismatch in lengths!"
